...
def subplot_smooth_2d(ax,x,y,Z,fplot='contourf',xmin=None,xmax=None,nx=50,nlev=50,vmin=None,vmax=None,**kwargs):
    """
...
def compute_tick_labels(xranks):
...
def set_frame_invlog(ax,xranks,yranks,aspect='1'):
    ...
    Nx = len(x)
    Ny = len(y)
    # h = subplot_smooth_2d(ax,x,y,Z,fplot='contourf',xmin=ymin,xmax=ymin,nx=50,nlev=50,vmin=None,vmax=None)
    ...
    # set xticks
    xticks, xticklabels = compute_tick_labels(xranks)
    ax.set_xticks(xticks)
    ax.set_xticklabels(xticklabels)

    # set yticks
    yticks, yticklabels = compute_tick_labels(yranks)
